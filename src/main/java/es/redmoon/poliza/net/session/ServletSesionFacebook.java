 ...
 * @author antonio
 */
public class ServletSesionFacebook extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String xlocale = request.getParameter("locale");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServletSesionFacebook.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public String getServletInfo() {
        return "Servicio de identidad federada through Facebook";
    }// </editor-fold>
}
