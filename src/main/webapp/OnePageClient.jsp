                ...
                <div class="col-lg-12">
                    ...
                    <table class="table table-striped table-bordered" id="oTablaPolizas">
                        ...
                        <div class="pagination">
                            <ul>
                                <li><a onclick="conn.PrevPage('accion=LeerPolizasByNIF');">Anterior</a></li>

                                <li class="active"><a href="#" id="xPag">1</a></li>

                                <li><a onclick="conn.NextPage('accion=LeerPolizasByNIF');">Siguiente</a></li>
                            </ul>
                        </div>
                                    <script>
