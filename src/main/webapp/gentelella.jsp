      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Prodacon</span></a>
            </div>
        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> Búsquedas <small>pólizas o siniestros</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Pólizas</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Siniestros</a>
                        </li>
                      </ul>
                      <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                          ...
                          <div class="title_right">
                            <div class="col-md-10 col-sm-5 col-xs-12 form-group pull-right top_search">
                                ...
                                <table class="table table-striped table-bordered" id="oTabla">
                                    <thead>
                                        <tr>
                                            ...
                                            <td width="30%"><strong>Riesgo asegurado</strong></td>
                                            <td width="15%"></td>
                                        </tr>
                                </table>
                          </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                          <p>Rejilla de la búsqueda de siniestros</p>
                        </div>
                      </div>
                    </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>Producción <small>pólizas por mes</small></h3>
                  </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <table class="tile_info">
                          <tr>
                            <td>
                              <p><i class="fa fa-square blue"></i>Autos </p>
                            </td>
                            <td>30%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square purple"></i>Vida </p>
                            </td>
                            <td>20%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square aero"></i>Diversos </p>
                            </td>
                            <td>15%</td>
                          </tr>
                        </table>
        ...
        <footer>
          <div class="pull-right">
            Poliza-Net - Portal web by <a href="https://polizainformatica.com">Póliza Informática</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    <script>
      $(document).ready(function() {
        ...
        $("#canvas_dahs").length && $.plot($("#canvas_dahs"), [
          ...
          colors: ["rgba(202, 225, 16, 0.38)", "rgba(3, 88, 106, 0.38)"],
          xaxis: {
